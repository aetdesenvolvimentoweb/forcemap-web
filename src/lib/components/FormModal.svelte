...
<dialog bind:this={dialog} class="modal" onclose={() => { errorMessage = null; }}>
  <div class="modal-box p-0 flex flex-col max-h-[90dvh]">
    <div class="bg-primary text-primary-content px-6 py-4 flex items-center justify-between shrink-0">
    ...
    >
      <div class="flex flex-col gap-5 px-6 py-6 overflow-y-auto flex-1">
        {#if errorMessage}
      ...
      <div class="flex justify-end gap-2 px-6 py-4 border-t border-base-200 bg-base-200/40 shrink-0">
